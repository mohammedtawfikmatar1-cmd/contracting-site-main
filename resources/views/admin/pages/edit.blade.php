        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                @if(!empty($enableMultilingual))
                    ...
                    <textarea name="content[ar]" class="form-control js-editor mb-2" data-editor-context="pages" rows="10">{{ old('content.ar', $page->getTranslation('content','ar')) }}</textarea>
                    <textarea name="content[en]" class="form-control js-editor" data-editor-context="pages" rows="10">{{ old('content.en', $page->getTranslation('content','en')) }}</textarea>
                @else
                    <!-- تعديل المحتوى بلغة واحدة -->
                    <textarea name="content" class="form-control js-editor" data-editor-context="pages" rows="12">{{ old('content', $page->getTranslation('content','ar') ?: $page->content) }}</textarea>
                @endif
            </div>
