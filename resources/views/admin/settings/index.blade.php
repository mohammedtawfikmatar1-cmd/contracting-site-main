    ...
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="key" class="form-control" required
                                placeholder="مثال: site_name أو contact_phone">
                            <small class="text-muted d-block mt-1">هذا الاسم تقني ويُستخدم داخل القوالب والبرمجة. إن لم تكن
                                متأكدًا اتركه للمطور.</small>
                        </div>
                        <div class="form-group">
                            <label>القيمة</label>
        ...
        <div class="col-md-8">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">جميع الإعدادات</h3>
                </div>
                                        ...
                                        <select name="type" class="form-control form-control-sm">
                                            ...
                                            @foreach (['text', 'longtext', 'image', 'color', 'json', 'boolean', 'integer'] as $type)
                                                <option value="{{ $type }}"
                                                    ...
                                                    {{ $typeLabels[$type] ?? $type }}</option>
                                            @endforeach
                                        </select>
                                        <input type="text" name="description" class="form-control form-control-sm mt-1"
                                            value="{{ $setting->description }}" placeholder="وصف للإدارة (اختياري)">
                                    </td>
                                    <td>
                                        ...
                                        <form action="{{ route('admin.settings.destroy', $setting) }}" method="POST"
                                            ...
                                            <button class="btn btn-sm btn-danger"
                                                onclick="return confirm('تأكيد الحذف؟')">حذف</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center">لا توجد إعدادات.</td>
                                </tr>
                            @endforelse
...
<div class="card-footer py-2 px-3">
    <div class="d-flex justify-content-center">
        ...
        {{ $settings->onEachSide(0)->links('pagination::simple-bootstrap-5') }}
