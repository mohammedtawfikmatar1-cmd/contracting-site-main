                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="icon" class="form-control icon-picker" value="{{ old('icon', $service->icon) }}" placeholder="اختر أيقونة">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="{{ old('icon', $service->icon) ?: 'fas fa-icons' }}"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
