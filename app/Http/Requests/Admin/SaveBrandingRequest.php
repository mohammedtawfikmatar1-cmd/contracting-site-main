...
class SaveBrandingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'surface_bg_color' => ['nullable', 'string', 'max:32'],
            'surface_alt_bg_color' => ['nullable', 'string', 'max:32'],
            'surface_text_color' => ['nullable', 'string', 'max:32'],
            'surface_muted_text_color' => ['nullable', 'string', 'max:32'],
            'border_color' => ['nullable', 'string', 'max:32'],
            'inverse_text_color' => ['nullable', 'string', 'max:32'],
            'overlay_color' => ['nullable', 'string', 'max:32'],
            'success_color' => ['nullable', 'string', 'max:32'],
            'warning_color' => ['nullable', 'string', 'max:32'],
            'danger_color' => ['nullable', 'string', 'max:32'],
